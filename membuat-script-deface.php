...
print "Selamat Script Deface Anda Telah Berhasil Di Buat"

print "setelah itu semua telah selesai kamu lanjutkann ketik ini"

print "cd /storage/emulated/0"

print "sekian dan terima kasih Solo Player By Ghost-Name
